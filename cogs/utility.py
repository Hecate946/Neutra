...
class Utility(commands.Cog):
    ...
    @commands.command(aliases=["emojisteal", "emojicopy", "emotesteal"])
    @commands.guild_only()
    ...
    @commands.command(aliases=['emoteremove'])
    @commands.guild_only()
    @permissions.has_permissions(manage_emojis=True)
    ...
    @commands.command(aliases=["listemojis"])
