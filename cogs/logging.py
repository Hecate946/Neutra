...
class Logging(commands.Cog):
    ...
    async def do_logging(self, ctx, channel):
        ...
        print(bytes_avatar)
        webhook = await channel.create_webhook(name=self.bot.user.name + "-logger", avatar=bytes_avatar, reason="Webhook created for server logging.")
        await self.bot.cxn.execute("UPDATE logging SET logging_webhook_id = $1 WHERE server_id = $2", str(webhook.id), ctx.guild.id)
        await self.bot.cxn.execute("UPDATE logging SET logchannel = $1 WHERE server_id = $2", channel.id, ctx.guild.id)
        ...
        await ctx.send(f"{self.emote_dict['success']} Set channel {channel.mention} as this server's logging channel.")
    ...
    async def logchannel(self, ctx, channel: discord.TextChannel = None):
        ...
        for webhook in server_webhook_list:
            if str(webhook.id) == str(webhook_id):
                return await ctx.send(f"{self.emote_dict['error']} Logging is already set up on this server")
    ...
    async def unlogchannel(self, ctx):
        ...
        found = []
        for webhook in server_webhook_list:
            if str(webhook.id) == str(self.bot.server_settings[ctx.guild.id]['logging']['webhook_id']):
                found.append(webhook.name)
        if found:
            await webhook.delete(reason=f"Logging webhook deleted by {ctx.author}.")
            await self.bot.cxn.execute("UPDATE logging SET logging_webhook_id = NULL WHERE server_id = $1", ctx.guild.id)
            await self.bot.cxn.execute("UPDATE logging SET logchannel = NULL WHERE server_id = $1", ctx.guild.id)
            await ctx.send(f"{self.emote_dict['success']} Logging is now disabled on this server")
            return
        else:
            return await ctx.send(f"{self.emote_dict['error']} Logging is not enabled on this server.")
    ...
    async def _deletes(self, ctx):
        logchan = await self.bot.cxn.fetchrow("""
        SELECT logchannel FROM logging WHERE server_id = $1
        """, ctx.guild.id) or None
        if logchan is None or logchan[0] is None: 
            return await ctx.send(f"{self.emote_dict['failed']} Logging not setup on this server. Use `{ctx.prefix}logserver` to setup a logging channel.")
        ...
        """, True, ctx.guild.id)
        await ctx.send(f"{self.emote_dict['success']} Message deletions will now be logged in {logchan.mention}")
    ...
    async def _edits(self, ctx):
        ...
        """, ctx.guild.id) or None
        if logchan is None or logchan[0] is None: 
            return await ctx.send(f"{self.emote_dict['failed']} Logging not setup on this server. Use `{ctx.prefix}logchannel` to setup a logging channel.")
        ...
        """, True, ctx.guild.id)
        await ctx.send(f"{self.emote_dict['success']} Message edits will now be logged in {logchan.mention}")
    ...
    async def _roles(self, ctx):
        ...
        """, True, ctx.guild.id)
        await ctx.send(f"{self.emote_dict['success']} Role changes will now be logged in {logchan.mention}")
    ...
    async def _names(self, ctx):
        ...
        """, True, ctx.guild.id)
        await ctx.send(f"{self.emote_dict['success']} Name changes will now be logged in {logchan.mention}")
    ...
    async def _voice(self, ctx):
        ...
        """, True, ctx.guild.id)
        await ctx.send(f"{self.emote_dict['success']} Voice state updates will now be logged in {logchan.mention}")
    ...
    async def _avatars(self, ctx):
        ...
        """, True, ctx.guild.id)
        await ctx.send(f"{self.emote_dict['success']} Avatar changes will now be logged in {logchan.mention}")
    ...
    async def _bans(self, ctx):
        ...
        """, True, ctx.guild.id)
        await ctx.send(f"{self.emote_dict['success']} Server bans will now be logged in {logchan.mention}")
    ...
    async def _channels(self, ctx):
        ...
        UPDATE logging SET bans = $1 WHERE server_id = $2
        """, True, ctx.guild.id)
        await ctx.send(f"{self.emote_dict['success']} Channel updates will now be logged in {logchan.mention}")
    ...
    async def _leaves(self, ctx):
        ...
        """, True, ctx.guild.id)
        await ctx.send(f"{self.emote_dict['success']} Member leave will now be logged in {logchan.mention}")
    ...
    async def _joins(self, ctx):
        ...
        """, True, ctx.guild.id)
        await ctx.send(f"{self.emote_dict['success']} Membed join will now be logged in {logchan.mention}")
    ...
    async def voice_(self, ctx):
        ...
        UPDATE logging SET voice_state_updates = $1 WHERE server_id = $2
        """, False, ctx.guild.id)
        await ctx.send(f"{self.emote_dict['success']} Voice state updates will no longer be logged in {logchan.mention}")
    ...
    async def avatar_(self, ctx):
        ...
        UPDATE logging SET avatar_changes = $1 WHERE server_id = $2
        """, False, ctx.guild.id)
        await ctx.send(f"{self.emote_dict['success']} Avatar changes will no longer be logged in {logchan.mention}")
    ...
    async def channels_(self, ctx):
        ...
        """, False, ctx.guild.id)
        await ctx.send(f"{self.emote_dict['success']} Server bans will no longer be logged in {logchan.mention}")
    ...
    async def leaves_(self, ctx):
        ...
        UPDATE logging SET leaves = $1 WHERE server_id = $2
        """, False, ctx.guild.id)
        await ctx.send(f"{self.emote_dict['success']} Server leaves will no longer be logged in {logchan.mention}")
    ...
    async def joins_(self, ctx):
        ...
        """, False, ctx.guild.id)
        await ctx.send(f"{self.emote_dict['success']} Server joins will no longer be logged in {logchan.mention}")